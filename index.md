...
<head>
    ...
    <style>
        /* ВСЕ СТИЛИ ОСТАЮТСЯ ЗДЕСЬ, КАК В ПРЕДЫДУЩЕМ КОДЕ */
        /* Я удалил внешнюю ссылку на SCSS, которая вызывала ошибку */
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleFoodClick() {
                ...
                // Создаем частицы
                createParticles(5 + Math.floor(Math.random() * 5), '#FF9A9E');
            ...
            function activateBoost(type, duration, multiplier) {
                ...
                elements.boostText.textContent = `${type === 'pepper' ? '🌶️ x3 XP' : '⚡ Буст'} - ${duration}с`;
            ...
            function checkBoosts() {
                if (gameState.boostEndTime > 0 && Date.now() > gameState.boostEndTime) {
                    ...
                    elements.boostText.textContent = `🌶️ x3 XP - ${timeLeft}с`;
                }
            }
            ...
            function autoClick() {
                if (gameState.autoClicker > 0) {
                    ...
                    for (let i = 0; i < autoClicks; i++) {
                        ...
                        // Создаем частицы каждые 5 автокликов
                        if (i % 5 === 0) {
                            createParticles(2, '#4ECDC4');
                        }
                    }
                    updateUI();
                }
            ...
            function createParticles(count, color) {
                ...
                for (let i = 0; i < count; i++) {
                    ...
                    // Случайная позиция
                    const foodRect = elements.mainFood.getBoundingClientRect();
